...
set title "Validation Acc  vs. training iterations"
set xlabel "Training iterations"
set ylabel "Validation Acc"
#plot "alex1.log.test" using 1:3 title "AlexH fine tuned Accuracy", "alex1.log.test" using 1:4 title "AlexH fine tuned Loss"

plot "logMITfinetunedgoogle.txt.test" using 1:3 title "svhn VAL Accuracy"
#plot "cset4a.log.test" using 1:3 title "c4 fine tuned Acc","cset2a.log.test" using 1:3 title "c2 fine tuned Acc", "cset1.log.test" using 1:3 title "c1 fine tuned Acc"
